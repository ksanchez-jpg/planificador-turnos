...
# --- MOTOR DE CÁLCULO (LOGICA PURA SIN CITAS) ---
...
def calcular_motor_final(n_ops, d_req, n_req, d_semana, seed):
    ...
    for bloque_idx in [0, 21]:
        ...
        # Modo bloque intenta mantener 3 días seguidos. Modo rescate mete turnos donde haya hueco.
        for modo in ["bloque", "rescate"]:
            for limite_ref in [0, 1, 2]: # Capa progresiva de refuerzos
...
if "df" in st.session_state:
    ...
    # Crear df visual limpio para evitar KeyError en el Styler
